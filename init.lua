...
spec "user.lualine"
spec "user.whichkey"
spec "user.dap" -- debugger, check how to use it.
-- spec "user.autotag"
-- spec "user.sleuth"
spec "user.cmp"
spec "user.autopairs"
...
spec "user.alpha" -- just a simple greeter for neovim.
spec "user.netrw"
spec "user.project"
...
spec "user.extras.various-textobjs" -- text objects
spec "user.extras.spider" -- move by subwords & skip punctuation.
